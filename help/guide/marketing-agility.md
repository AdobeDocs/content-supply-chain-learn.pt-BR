---
title: Agilidade de marketing - capacite os não criativos a crescer
description: Veja os tutoriais da Cadeia de fornecimento de conteúdo do Adobe, às vezes, uma solicitação de conteúdo pode ser atendida sem o tratamento completo da equipe criativa/estúdio. O Adobe coloca as ferramentas nas mãos de profissionais de marketing e outros possíveis criadores de conteúdo, de modo que os turnos rápidos na criação de variações e atualizações de conteúdo possam ser executados por um grupo maior e mais amplo de indivíduos conectados à Cadeia de fornecimento de conteúdo, aumentando drasticamente a taxa de transferência de conteúdo e o tempo de entrada no mercado.
...
As soluções de Adobe usadas para agilidade de marketing:
...
* Gerar conteúdo rapidamente para campanhas de resposta rápida
* Remixar conteúdo existente mantendo-o na marca
* Automatizar a produção de ativos derivados (tamanho, canal)
...
<div class="columns is-multiline"><div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Using Smart Crop with AEM Assets Dynamic Media" tabIndex="0">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/images/smart-crop-feature-video-use.html?lang=pt-BR" title="Uso do Corte inteligente com o AEM Assets Dynamic Media" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/21519?format=jpeg" alt="Uso do Corte inteligente com o AEM Assets Dynamic Media">
        </a>
      </figure>
    </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-social-posters.html" title="Criar cartazes sociais com o Firefly" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3420533?format=jpeg" alt="Criar cartazes sociais com o Firefly">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-social-posters.html" title="Criar cartazes sociais com o Firefly">Criar cartazes sociais com o Firefly</a>
          </p>
          <p class="is-size-6"><em>Saiba como usar Texto para imagem, ativado por Adobe Firefly, no Adobe Express para criar uma campanha de promoção para redes sociais. Este tutorial usa o novo Adobe Express.</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-webinar-poster.html" title="Criar cartazes de webinário com o Firefly" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-blog-graphics.html" title="Executar campanhas sociais facilmente" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>Saiba como usar Texto para imagem habilitado por Adobe Firefly no Adobe Express para criar elementos gráficos exclusivos para o recrutamento de funcionários e conteúdo de integração.</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-local-marketing.html" title="Criar conteúdo de panfleto para campanha de marketing com o Firefly" tabindex="-1">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-local-marketing.html" title="Criar conteúdo de panfleto para campanha de marketing com o Firefly">Criar conteúdo de panfleto para campanha de marketing com o Firefly</a>
          </p>
          <p class="is-size-6"><em>Saiba como usar Texto para imagem, ativado por Adobe Firefly, no Adobe Express para criar conteúdo localizado a partir de uma campanha global de marketing de hotel. </em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>Saiba como uma equipe de comércio pode criar facilmente imagens atraentes para um novo conjunto de inventário em sua loja online.</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html" title="Capacite as equipes de marketing para criar conteúdo multicanal" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3424446?format=jpeg" alt="Capacite as equipes de marketing para criar conteúdo multicanal">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/content-automation/overview.html" title="Visão geral da Automação de conteúdo com serviços Creative Cloud" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/333197?format=jpeg" alt="Visão geral da Automação de conteúdo com serviços Creative Cloud">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-express.html" title="integração de Adobe Express" tabindex="-1">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-express.html" title="integração de Adobe Express">integração de Adobe Express</a>
          </p>
          <p class="is-size-6"><em>Saiba como otimizar as cadeias de fornecimento de conteúdo com o AEM Assets e o Adobe Express, aumentando a produtividade e a acessibilidade para todos os membros da equipe.</em></p>
      </div>
